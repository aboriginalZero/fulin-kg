这里的问题是 localized loc = [16, 7, 13, 8]，这一步已经错了，应该是 [16, 7, 13, 4]，LocalizedComparator 中不能选同一节点。理论上在迁移过程中，如果 dst cid 跟 replace cid 在同一节点上，那么会让 replace cid 选跟 dst cid 在同一节点上，但是这里由于 7 在 expected_cid_set 上，所以被 continue 了，8 成了漏网之鱼。

需要改一下 LocalizedComparator 生成的局部化期望列表规则。

```
std::vector<cid_t> candidate_replace_cids;
FOREACH_VALID_SEGMENT_IN_EXT_LOC(current_loc, cid) {
	if (expected_cid_set.count(cid)) continue;

    if (AreChunksInSameNode(cid, ctx->dst_cid)) {
        ctx->replace_cid = cid;
        return rt == RT_REPLICA ? GetSrcCidForReplicaMigration(ctx) : GetSrcCidForECMigration(ctx);
    }
...
```
I0319 13:55:29.057196 42205(meta-rpc-server) topology.cc:369] [RING ID AND TOPO INFO]:
{ cid: 1, ring id: 9, topo distance: (cid, val), (2, -72), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, 0), (10, 0), (11, 0), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 2, ring id: 12, topo distance: (cid, val), (1, -72), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, 0), (16, 0), (17, 0), (18, -72), (19, -72), (20, -72) }
{ cid: 3, ring id: 16, topo distance: (cid, val), (1, -72), (2, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, 0), (13, 0), (14, 0), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 4, ring id: 8, topo distance: (cid, val), (1, -72), (2, -72), (3, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, 0), (19, 0), (20, 0) }
{ cid: 5, ring id: 20, topo distance: (cid, val), (1, -584), (2, -584), (3, -584), (4, -584), (6, 0), (7, 0), (8, 0), (9, -584), (10, -584), (11, -584), (12, -584), (13, -584), (14, -584), (15, -584), (16, -584), (17, -584), (18, -584), (19, -584), (20, -584) }
{ cid: 6, ring id: 15, topo distance: (cid, val), (1, -584), (2, -584), (3, -584), (4, -584), (5, 0), (7, 0), (8, 0), (9, -584), (10, -584), (11, -584), (12, -584), (13, -584), (14, -584), (15, -584), (16, -584), (17, -584), (18, -584), (19, -584), (20, -584) }
{ cid: 7, ring id: 5, topo distance: (cid, val), (1, -584), (2, -584), (3, -584), (4, -584), (5, 0), (6, 0), (8, 0), (9, -584), (10, -584), (11, -584), (12, -584), (13, -584), (14, -584), (15, -584), (16, -584), (17, -584), (18, -584), (19, -584), (20, -584) }
{ cid: 8, ring id: 10, topo distance: (cid, val), (1, -584), (2, -584), (3, -584), (4, -584), (5, 0), (6, 0), (7, 0), (9, -584), (10, -584), (11, -584), (12, -584), (13, -584), (14, -584), (15, -584), (16, -584), (17, -584), (18, -584), (19, -584), (20, -584) }
{ cid: 9, ring id: 19, topo distance: (cid, val), (1, 0), (2, -72), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (10, 0), (11, 0), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 10, ring id: 14, topo distance: (cid, val), (1, 0), (2, -72), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, 0), (11, 0), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 11, ring id: 4, topo distance: (cid, val), (1, 0), (2, -72), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, 0), (10, 0), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 12, ring id: 11, topo distance: (cid, val), (1, -72), (2, -72), (3, 0), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (13, 0), (14, 0), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 13, ring id: 6, topo distance: (cid, val), (1, -72), (2, -72), (3, 0), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, 0), (14, 0), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 14, ring id: 1, topo distance: (cid, val), (1, -72), (2, -72), (3, 0), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, 0), (13, 0), (15, -72), (16, -72), (17, -72), (18, -72), (19, -72), (20, -72) }
{ cid: 15, ring id: 17, topo distance: (cid, val), (1, -72), (2, 0), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (16, 0), (17, 0), (18, -72), (19, -72), (20, -72) }
{ cid: 16, ring id: 2, topo distance: (cid, val), (1, -72), (2, 0), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, 0), (17, 0), (18, -72), (19, -72), (20, -72) }
{ cid: 17, ring id: 7, topo distance: (cid, val), (1, -72), (2, 0), (3, -72), (4, -72), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, 0), (16, 0), (18, -72), (19, -72), (20, -72) }
{ cid: 18, ring id: 3, topo distance: (cid, val), (1, -72), (2, -72), (3, -72), (4, 0), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (19, 0), (20, 0) }
{ cid: 19, ring id: 18, topo distance: (cid, val), (1, -72), (2, -72), (3, -72), (4, 0), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, 0), (20, 0) }
{ cid: 20, ring id: 13, topo distance: (cid, val), (1, -72), (2, -72), (3, -72), (4, 0), (5, -584), (6, -584), (7, -584), (8, -584), (9, -72), (10, -72), (11, -72), (12, -72), (13, -72), (14, -72), (15, -72), (16, -72), (17, -72), (18, 0), (19, 0) }
I0319 13:55:29.060130 42205(meta-rpc-server) chunk_manager.cc:975] [UPDATE TOPO OBJ]: [REQUEST]: id: "3c27a2aa-10d4-4cae-ba16-1fd37df64ab2" new_parent_id: "09013c62-249d-4a98-8736-a332202bd525" new_position { row: 2 column: 2 }, [RESPONSE]: ST:OK, type: NODE id: "3c27a2aa-10d4-4cae-ba16-1fd37df64ab2" parent_id: "09013c62-249d-4a98-8736-a332202bd525" name: "node-10.0.134.161" create_time: 1741335130 position { row: 2 column: 2 } capacity { row: 1 column: 1 } dimension { row: 1 column: 1 }, [TIME]: 8077 us.

/var/log/zbs/zbs-metad.log.20250316-090139.2860:89980:I0319 13:55:34.114343 31044(recover-manager) recover_manager.cc:1890] generate migrate cmd for localization in load: LOAD_LOW, pk: PK_CAP, first pid: 1
/var/log/zbs/zbs-metad.log.20250316-090139.2860:90223:I0319 13:55:34.116356 31044(recover-manager) recover_manager.cc:589] [REPOSITION] distribute migrate cmd for pid: 657659 lid: 162014 src: 11 dst: 7 replace: 11 owner: 11 prefer local: 16 pt: PT_CAP is_thick: 0 rt: RT_EC ever exist: 1 current loc: [ 0:18 1:16 2:8 3:11 ] alive loc: [ 0:18 1:16 2:8 3:11 ] dst_shard_idx: 3
```
